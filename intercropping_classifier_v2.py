...
MODEL_PATH = 'intercropping_classifier_v2.h5'
HISTORY_PATH = 'intercropping_training_history_v2.png'
...
def plot_training_history(history, phase_idx):
    ...
    plt.legend(['Train', 'Validation'], loc='upper left')
    plt.tight_layout()
    plt.savefig(f'intercropping_training_history_v2_phase_{phase_idx + 1}.png')
    plt.close()
...
for phase_idx, phase in enumerate(training_phases, 1):
    ...
    # Save phase model
    model.save(f'intercropping_classifier_v2_phase_{phase_idx}.h5')
